...
/* ------------------------------------------------------------------------
   ...
   (1) for floating point arithmetic:
       prompt> solpow-fpa <input file name>
   (2) for rounded iterval arithmetic:
       prompt> solpow-ria <input file name>

   Example: intersection between a circle x^2 + y^2 = 1 and 
         an ellipse (x^2)/4 + 4(y^2) = 1 in the first quadrant: 
       prompt> solpow-fpa solpow.in
       prompt> solpow-ria solpow.in   
------------------------------------------------------------------------- */
