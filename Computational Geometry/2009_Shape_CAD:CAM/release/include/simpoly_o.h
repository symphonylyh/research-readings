...
public:
  ...
  friend ostream& operator<<(ostream&, rlist_element* &);
  friend ostream& operator<<(ostream&, rlist_element &);
...
class rootlist {
 ...
 public:
     ...
     friend rootlist_array;
  friend ostream& operator<<(ostream& , rootlist* );
  friend ostream& operator<<(ostream& , rootlist &);
};
...
class bagrootlist_element: public rlist_element {
 ...
 public:
   ...
   friend ostream& operator<<(ostream&, bagrootlist_element* );
};
...
class bagroot_list: public rootlist {
 ...
 public:
	...
	by new */
     ...
     friend ostream& operator<<(ostream& output, bagroot_list*&);
};

/* array of rlist_element */
class root_array: public generic_array {
 protected:
 ...
 public:
     ...
     void resize (int siz) {p=ralloc(siz*sizeof(rlist_element));n=siz;}

  friend ostream& operator<<(ostream& , root_array &);
};
...
public:
  ...
  friend ostream& operator<<(ostream& output, integer_element &ie){
       output << " u = " << ie.u << endl;
       return output;
  }
};
...
public:
  ...
  friend ostream& operator<<(ostream& , integerlist* &);
};

class rootlist_array:  public generic_array {
 protected:
 ...
 public:
     ...
     rootlist &operator[](int i) {
	  if (i >= n) {
	       cout << " error: in rootlist_array[]" << endl;
	       exit(1);
	  }
	  return (((rootlist *)p)[i]);
     }
     void resize (int siz) {p=ralloc(siz*sizeof(rootlist));n=siz;}

  friend ostream& operator<<(ostream& , rootlist_array &);
};
